    ...
    if(isset($_SESSION["Email"])){
        ...
        while($data_db = $request->fetch()){
            if($userEmail == $data_db["email"]){
                ...
                //Récupération des données provenant de la base dans des variables
                $useName= $data_db['nom'];
...
<body >
        <!--Navbar-->
            <div class="navbar fixed-top navbar-expand-md navbar-dark primary-color">
                    <a href="#" class="navbar-brand">
                        <div class="container_logo " style="width:110px; height:50px;">
                            <img class="img-fluid" style="width:fit-content; height:fit-content;" src="../Image/log_uvs2.png">
                        </div>
                    </a>
                        <div class="form-user-icon-main-container" style="position:relative; left:310px">
                            <div class="container-form-user-icon" style="display:flex;">
                                <div class="form-search-container">
                                    <form class="form-inline" action="search_traitement.php" method="POST">
                                        <input name="search" class="form-control" type="search" placeholder="Search" aria-label="Search" style="width:300px; height:32px;">
                                        <button class="btn bg-light btn-sm" type="submit" name="submit_search">
                                        ...
                                        <ul class="navbar-nav">
                                            <li class="nav-item dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right dropdown-default" aria-labelledby="navbarScrollingDropdown">
                                                    ...
                                                    <li><a class="dropdown-item" href="../PHP/deconnexion.php">Déconnexion</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    <!--Icon user-->
    ...
    <div class="container-fluid">
          ...
          <!--Card Présentation-->
                <div class="card">
                    ...
                    <div class="card-body " style="display:flex;">
                        <div class="Gestion_containeur">
                            ...
                            <p class="card-text">Ce site est dedie aux personnels de l'uvs afin qu'ils puisse y trouver les directives qu'ils doivent suivre
                                pour le bon fonctionnement de l'université.</p>
                        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                <h4 class="header">Evénement Université</h4>
                </div>

                <!--Filtre button-->
                    <div class="col-md-6">
                        <div class="dropdown text-right">
                            <button class="btn btn-right btn-primary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fa fa-filter" aria-hidden="true"></i>
                                Filtre
                            </button>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="#" value="Activités">Activités</a>
                ...
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <table class="table table-bordered table-primary table-striped">
                                ...
                                ?>
                                      <tbody>
                                      <tr>
                                      <th scope="row"><?php echo("<p>".$id."</p>");?></th>
                ...
                <table class="table table-bordered table-success table-striped">
                    ...
                    <tbody>
                        ...
                        <th scope="row">8h-10h</th>
                            <td>Nettoyage Grand amphi</td>
                            <td>Nettoyage salle Prof</td>
                            <td>Nettoyage petit amphi</td>
                            <td>Nettoyage salle informatique</td>
                            <td>Nettoyage Premier étage </td>
                            <td>Dépoussièrage</td>
                            <td>Repos</td>
                        </tr>
                        <tr>
                        ...
                        <tr class="table-danger">
                            ...
                            <td colspan="8" class="text-center">Pause</td>
                        </tr> 
                        <tr>
    ...
    <footer class="bg-primary text-center text-white">
                ...
                <div class="container p-4 pb-0">
                    ...
                    <section class="mb-4">
                        <!-- Facebook -->
                        <a class="btn btn-primary btn-floating" href="https://www.facebook.com/#!/" role="button"
                            ><i class="fab fa-facebook-f"></i
                        ></a>

                        <!-- Twitter -->
                        <a class="btn btn-secondary btn-floating" href="https://twitter.com/?lang=fr" role="button"
                            ><i class="fab fa-twitter"></i
                        ></a>

                        <!-- Google -->
                        <a class="btn btn-success btn-floating" href="https://www.google.com/" role="button"
                            ><i class="fab fa-google"></i
                        ></a>

                        <!-- Instagram -->
                        <a class="btn btn-danger btn-floating" href="https://www.instagram.com/?hl=fr" role="button"
                            ><i class="fab fa-instagram"></i
                        ></a>

                        <!-- Linkedin -->
                        <a class="btn btn-white btn-floating" href="https://fr.linkedin.com/" role="button"
                            ><i class="fab fa-linkedin-in"></i
                        ></a>

                        <!-- Github -->
                        <a class="btn btn-dark btn-floating " href="#!" role="button"
